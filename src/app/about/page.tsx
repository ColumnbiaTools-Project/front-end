...
export default function AboutPage() {
  ...
  <div className="relative">
    { isScrolled200
      ?
      <div className="w-full h-screen flex justify-center items-center clip-circle fixed z-[2] bg-white"
        data-aos={isScrolled ? "1979-anim" : ""}
        data-aos-duration="1000">
        <div className="text-[200px] font-bold z-[3] translate-x-[400px]">2023</div>
        <div className="text-[26px] z-[3] opacity-0 translate-x-[80px]">
    ...
    <div className="w-full h-screen bg-black fixed top-[0px] flex justify-end items-end">
      <div className="text-testRed">{positionY}</div>
    </div>
    ...
    <div className="w-full h-[842px] bg-white flex justify-center items-center">
      <div>
        <div>
          ...
          고무, 플라스틱 및 알루미늄을 사용하여 북미에서 제조해오래도록 사용할 수 있습니다.
          </div>
        </div>
        <Image src="/about/about2.png" width={542} height={542} alt="image2"/>
      </div>
    </div>
    <div className="w-full h-[842px] bg-white flex justify-center items-center">
      <div>
        <Image src="/about/about3.png" width={542} height={542} alt="image3"/>
        <div>
          <h3>고객과의 소통</h3>
          <p>Instagram, Facebook, Tik Tok, YouTube</p>
          <div>
          고객과 직접 소통하는 것은 Columbia Tools의 최우선 과제 중 하나입니다.<br/>
          Instagram, Facebook, Tik Tok, YouTube에서당사의 제품을 만나고, 저희와 채팅하실 수 있습니다.<br/>
