    ...
    <>
      <div>
        ...
        <div className={"mt-[40px]"}>
          ...
          <div className={"mt-[40px]"}>
            <li className={"pb-2"}>
              고객의 단순한 변심으로 교환, 반품 및 환불을 요구할 때 수반되는
              배송비는 고객님께서 부담하셔야합니다.
            </li>
            <li>
              상품을 개봉했거나 설치한 후에는 상품의 재판매가 불가능하므로
              고객님의 변심에 대한 교환, 반품이 불가능함을 양지해 주시기
              바랍니다
            </li>
          </div>
        </div>
        ...
        <div
          className={"mt-[100px] mb-[200px] flex justify-center items-center"}
        >
          <button
            className={
              "w-[444px] p-[23px] bg-black text-white text-[24px] flex justify-center items-center"
            }
            onClick={handleClick}
          >
            결제하기
